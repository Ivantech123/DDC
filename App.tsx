...
const App: React.FC = () => {
  ...
  const buildTelegramLink = (message: string) => {

    const encoded = encodeURIComponent(message);

    return TG_CONTACT.includes('?')

      ? `${TG_CONTACT}&text=${encoded}`
            ...
            {activeTab === Tab.CART && (
               ...
               >
                  ...
                  <h2 className="text-2xl font-bold text-white">
                    ...
                    Корзина <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">заказа</span>

                  </h2>

                  <p className="text-sm text-zinc-400 max-w-sm mx-auto">

                    Проверь товары и оформи оплату в личке.
              ...
              >
                ...
                {cartItems.length === 0 ? (
                  ...
                  <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-center">
                    ...
                    <p className="text-sm text-zinc-500">Корзина пустая.</p>

                    <button

                      onClick={() => setActiveTab(Tab.SHOP)}

                      className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-white text-black rounded-xl text-sm font-semibold active:scale-95"
                  ...
                  <>
                    ...
                    <div className="space-y-3">
                      ...
                      {cartItems.map(item => (
                        ...
                        <div key={item.id} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="w-8 h-8 rounded-lg bg-zinc-800 text-white hover:bg-zinc-700 active:scale-95"
                            ...
                            <button
                              ...
                              className="w-8 h-8 rounded-lg bg-purple-600 text-white hover:bg-purple-700 active:scale-95"
                    ...
                    <a
                      ...
                      href={buildTelegramLink(checkoutMessage)}

                      target="_blank"

                      rel="noopener noreferrer"

                      className="mt-2 w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl font-semibold transition-all active:scale-95 bg-purple-600 text-white hover:bg-purple-700 shadow-lg shadow-purple-500/30"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-6 pt-2 pointer-events-none">
        ...
        <div className="max-w-md mx-auto bg-zinc-950/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-2 flex gap-1 pointer-events-auto">
          ...
          >
            ...
            <ShoppingCart className={`w-5 h-5 transition-colors ${activeTab === Tab.CART ? 'text-purple-400' : ''}`} />
